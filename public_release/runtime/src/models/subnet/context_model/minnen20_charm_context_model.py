    ...
    def __init__(self,
        ...
        for slice_ind in range(num_slices):
            ...
            self.mean_slice_transforms.append(
                SliceTransform(in_ch=support_slices_ch+hyper_mean_ch, out_ch=slice_ch))
            self.scale_slice_transforms.append(
                SliceTransform(in_ch=support_slices_ch+hyper_scale_ch, out_ch=slice_ch))
            self.lrp_slice_transforms.append(
                SliceTransform(in_ch=support_slices_ch+hyper_mean_ch+slice_ch, out_ch=slice_ch))
