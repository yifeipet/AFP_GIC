...
from external_libs.adacode.network_swinir import RSTB
from external_libs.adacode.fema_utils import ResBlock, CombineQuantBlock
from external_libs.adacode.vgg_arch import VGGFeatureExtractor
from external_libs.adacode.femasr_arch import MultiScaleEncoder, SwinLayers, DecoderBlock
from external_libs.adacode.RRDB_arch import RRDB, make_layer
...
class AdaCodeSRNet(nn.Module):
    def __init__(self,
        ...
        self.weight_cri = None # build_loss({'type': 'SoftCrossEntropy'})
